...
if __name__ == "__main__":
    ...
    inputs = {
        "easy": (
            load_image(images / "/home/zhaoyibin/3DRE/sfm-learn/SFM_OWN/DATA/dtu/scan10/images/00000021.jpg"),
            load_image(images / "/home/zhaoyibin/3DRE/sfm-learn/SFM_OWN/DATA/dtu/scan10/images/00000022.jpg"),
        ),
        # "difficult": (
        #     load_image(images / "/home/zhaoyibin/3DRE/sfm-learn/SFM_OWN/DATA/dtu/scan10/images/00000021.jpg"),
        #     load_image(images / "/home/zhaoyibin/3DRE/sfm-learn/SFM_OWN/DATA/dtu/scan10/images/00000022.jpg"),
    ...
    for name, conf in configs.items():
        ...
        matcher = LightGlue(features="mega", flash=not args.no_flash, **conf)
        ...
        for pair_name, ax in zip(inputs.keys(), axes):
            ...
            for num_kpts in args.num_keypoints:
                ...
                timecost=end-start
                runtime = measure(matcher,{"image0": feats0, "image1": feats1},device=device,r=args.repeat,)["mean"]
                results[pair_name][name].append(1000 / runtime if args.measure == "throughput" else runtime)
            ax.plot(args.num_keypoints, results[pair_name][name], label=name, marker="o")
