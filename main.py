...
def main(imgpaths,camK,imgnum):
    ...
    list_kp_1s, list_kp_2s, matchidxs = LightGlue_extraction.lightglue_extract_feature()
    # 处理0号，1号两张图片
    list_kp0, list_kp1, _ = LightGlue_extraction.get_feature(0, 1)
    ...
    list_kp1, list_kp2, _ = LightGlue_extraction.get_feature(1, 2)
    points3d_12_cam0, R02, t02 = SFM.increment_sfm(co_points3d_01_cam0, co_feature12_pic2_xy, camK, R01, t01, list_kp1,
                                                   list_kp2)

    # 处理1号，2号两张图片
    list_kp2, list_kp3, _ = LightGlue_extraction.get_feature(2, 3)
    co_feature_idx, co_feature12_pic1_xy, co_feature12_pic2_xy, co_feature23_pic3_xy = LightGlue_extraction.get_co_feature(1,
                                                                                                                      2,
                                                                                                                      3)
    # 从1号，2号图片重建得到的点云中，按索引挑选出共视特征点的点云
    co_points3d_12_cam0 = points3d_12_cam0[co_feature_idx, :]
    points3d_23_cam0, R03, t03 = SFM.increment_sfm(co_points3d_12_cam0, co_feature23_pic3_xy, camK, R02, t02, list_kp2,
                                                   list_kp3)
